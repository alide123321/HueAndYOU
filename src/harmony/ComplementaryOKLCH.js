...
Current color conversion pipelines are not handling the transition of
RGB - OKLCH safely, so for now the HSL generator is preferred over this one.
...
export class Complementary extends HarmonyStrategy {
  ...
  buildPalette(gs) {
    ...
    const baseDarkOK = darken(baseColorOK, 0.2);

    const complementaryDarkOK = darken(complementaryOK, 0.2);
